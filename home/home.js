...
//estamos pegando o elemento de forma generica - pode ser classe(precisa trazer o ponto) ou pode ser ID(precisa trazer a hashtag)
...
//opção com arrow function -> função